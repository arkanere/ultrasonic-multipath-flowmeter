 ...
 */
function simulateMeasurements(config, trueFlowVelocity) {
...
function printMeasurements(measurements, trueFlowVelocity) {
  console.log(
...
function runDemo(title, config, trueFlowVelocity) {
  console.log(`### ${title} ###\n`);
